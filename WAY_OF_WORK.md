...
- Output: `docs/masterplan/pdfjs-masterplan.md`, CLAUDE.md, ROADMAP.md
...
- Output: `docs/research/vooronderzoek-pdfjs.md`
...
- Output: updated `docs/masterplan/pdfjs-masterplan.md`, updated ROADMAP.md
...
- Output: `skills/source/pdfjs-{category}/{skill-name}/`
...
2. Essential Patterns (with TypeScript/JavaScript code examples)
3. Common Operations (code snippets)
4. Reference Links (to references/ files)

### Naming Convention
- `pdfjs-{category}-{topic}`
- Prefix: `pdfjs-` (single technology, single prefix)
- Categories: syntax, impl, errors, core, agents
- Examples: `pdfjs-syntax-viewer`, `pdfjs-impl-custom-viewer`, `pdfjs-errors-worker`, `pdfjs-core-architecture`
...
5. TypeScript/JavaScript examples with proper imports?
